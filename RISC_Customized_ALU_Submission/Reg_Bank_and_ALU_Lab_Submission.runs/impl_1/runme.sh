...
HD_PWD='D:/COA_LAB/Final Assignments/RISC_Customized_ALU_Submission/Reg_Bank_and_ALU_Lab_Submission.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Master_Interface.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Master_Interface.tcl -notrace
